        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 animate-slide-in-left">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start items-center">
              ...
              <a
                href="/Arnav_Surana_Resume.pdf"
                download
                className="border-2 border-amber-400/50 text-white hover:bg-amber-400/10 hover:border-amber-400 px-8 py-4 rounded-full transition-all duration-300 font-semibold text-lg group flex items-center"
              >
